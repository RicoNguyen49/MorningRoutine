...
namespace Assignment10Ex4
{
    ...
    class Program
    {
        ...
        private static async Task<Shower> TakeAShowerAsync()
        {
          ...
          // hrow new InvalidOperationException(" you slipped and few hurting you ankle which means you cant make it to work");
        ...
        private static async Task<Drive> DriveToWorkAsync(int time)
        {
            ...
            await Task.Delay(1000);
          //throw new InvalidOperationException("You ran over a pothole and popped the front wheel!!!");
